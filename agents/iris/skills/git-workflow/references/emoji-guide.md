...
I'm passionate about automation and emojis have been used in Git for a while... here are some examples I've been using
on my repos based on different emoji automation projects. Mostly from
<https://www.emojiall.com/en/all-emojis?type=normal>.

To search for emojis based on a given keyword, just use
<https://emojidb.org/done-emojis?user_typed_query=1&utm_source=user_search>

## Language or platform-specific emojis

- These are my personal list of emojis for the things I didn't find before

| Emoji | Description | GitHub Code |
|-------|------------|-------------|
| ☕ | Coffee (Java) | `:coffee:` |
| 🐹 | Hamster (Golang) | `:hamster:` |
| 🦀 | Crab (Rust) | `:crab:` |
| 🐍 | Snake (Python) | `:snake:` |
| 🐘 | Elephant (Apache Hadoop) | `:elephant:` |
| 🍎 | Red Apple (Swift) | `:apple:` |
| 💎 | Gem Stone (Ruby) | `:gem:` |
| 🥐 | Croissant (Vue.js) | `:croissant:` |
| 🍦 | Ice Cream (React) | `:icecream:` |
| 🐋 | Whale (Apache Whale) | `:whale2:` |
| 🐙 | Octopus (Octave) | `:octopus:` |
| 🪐 | Saturn (Saturn.jl) | `:saturn:` |

## Utilities I'm maintaining

| Emoji | Description | GitHub Code |
|-------|------------|-------------|
| 🍪 | Web Cookies     | `:cookie:` |
| 📦 | Package (Package Manager) | `:package:` |
| ⚙️ | Gear (Configuration) | `:gear:` |
| 🗜️ | Clamp (Compression) | `:compression:` |
| 🏗 | Deployment / Infra | `:building_construction:` |
| 🐳 | Whale (Docker) | `:whale:` |
| ☸️ | Kubernetes          | `:wheel_of_dharma:` |
| 🎡 | Helm Charts       | `:ferris_wheel:` |
| 🧮 | Lambda Function   | `:abacus:` |
| 🍱 | Namespaces        | `:bento:` |
| ☁️  | Cloud Provider  | `:cloud:` |
| 🐬 | Dolphin (DolphinDB) | `:dolphin:` |
| 🐘 | Postgres            | `:elephant:` |
| 🥬 | Mongodb             | `:leafy_green:` |
| 🌱 | Migration script    | `:seedling:` |
| 🛢 | Database            | `:oil_drum:` |
| 🚮 | Garbage Collection  | `:put_litter_in_its_place:` |
| ✉️  | Email / Envelop     | `:email:` |
| 🔗 | Link                | `:link:` |
| 🩹 | Bug Patch | `:adhesive_bandage:` |
| 🤖 | AI   | `:robot:` |
| 💬 | Chat   | `:speech_ballon:` |
| 🦾 | AI Prompt | `:mechanical_arm:` |
| ⛓️ | Blockchain / Distributed Ledger | `:chain:` |
| 🧠 | ChatGPT | `:brain:` |
| 🏃 | Run Process | `:runner:` |
| 🐸 | Artifactory | `:frog:` |
| 🎛 | Settings    | `:control_knobs:` |
| 🛣 | Paved Road | `:motorway:` |
| 🚩 | Feature Flags | `:triangular_flag_on_post:` |
| 🧬 | Data Liniage | `:dna:` |
| 💸 | Cost Optimization | `:money_with_wings:` |
| 🏘 | Multi-tenant | `:houses:` |
| 🧶 | Node Yarn | `:yarn:` |
| ✂️  | Cut       | `:scissors:` |
| 🧹 | Clean-up  | `:broom:` |
...
| Emoji | Description | GitHub Code |
|-------|------------|-------------|
| ⏲️ | Timeout | `:timer_clock:` |
| 🏭 | Factory | `:factory:` |
| 📆 | Scheduler | `:calendar:` |
| 📢 | Notifications | `:loudspeaker:` |
| ⏯️ | Blocking / Wait | `:play_or_pause_button:` |
| 🔀 | Parallelism | `:twisted_rightwards_arrows:` |
...
Programoji is not an official or widely-adopted standard like Gitmoji, so it does not have associated GitHub emojis.
However, we can provide a modified table that replaces Programoji emojis with GitHub emojis that have similar meanings:
...
| 🚀 | Deployment | `:rocket:` |
| 💡 | Idea | `:bulb:` |
| 🛠️ | In Progress | `:hammer_and_wrench:` |
| 💡 | Solution | `:bulb:` |
| 🧪 | Testing | `:test_tube:` |
| 📖 | User Story | `:book:` |
| 🚢 | Release | `:ship:` |
| 📝 | Release Notes | `:pencil:` |

Note that these GitHub emojis are not a direct replacement for Programoji emojis, and that their meanings may vary
depending on the context of their use. Also note that the last GitHub emoji `:pencil:` is used for documentation and
release notes interchangeably, while in Practice Gitmojii of using 📝 mainly for documentation and 📄 for release notes
as I provided earlier.

Note that the tables for Codepoints and Gitmoji-cz only include a subset of the available emojis. The full list of
relevant emojis for Codepoints can be found on their website, while Gitmoji-cz only includes a selection of Gitmoji
emojis. The tables for emoji-commit and Programoji include some of the most commonly used emojis associated with
...
Sure, here's a table with Gitmoji emojis and their corresponding GitHub codes
...
| 🔨 | Add or update a feature | `:hammer:` |
| 🐛 | Fix a bug | `:bug:` |
| 🚑 | Critical hotfix | `:ambulance:` |
| ➕ | Add a dependency | `:heavy_plus_sign:` |
| 📦 | Add or update a package | `:package:` |
| 🚀 | Deploy stuff | `:rocket:` |
...
| 🔌 | Work with plugins | `:electric_plug:` |
| 🚤 | Work with Docker | `:speedboat:` |
| 📝 | Write documentation | `:pencil:` |
| 🎉 | Initial commit | `:tada:` |
| 💄 | Add or update the UI and style files | `:lipstick:` |
| 🚦 | Add or update tests | `:traffic_light:` |
| 🚥 | Add or update continuous integration | `:construction_worker:` |
| 🔗 | Add or update links | `:link:` |
| 🎵 | Add or update music and sounds | `:musical_note:` |
| 📱 | Work with responsive design | `:iphone:` |
| 🤡 | Mocking things | `:clown_face:` |
| 🚲 | Work with animations | `:bike:` |
| ✅ | Add or update testing | `:white_check_mark:` |
| ❌ | Remove tests | `:x:` |
| 🔒 | Work with security | `:lock:` |
| 🔑 | Add or update authentication / authorization | `:key:` |
| ⬆️ | Upgrade dependencies | `:arrow_up:` |
| ⬇️ | Downgrade dependencies | `:arrow_down:` |
| 👕 | Work with linters | `:shirt:` |
| 📌 | Pin dependencies | `:pushpin:` |
| ✏️ | Fix typos | `:pencil2:` |
| 💁‍♀️ | Add or update contributor guidelines | `:woman-raising-hand:` |
| 💬 | Work with text | `:speech_balloon:` |
| 🙈 | Add or update a .gitignore file | `:see_no_evil:` |
| 🧵 | Multi-threaded Env | `:thread:` |
...
| 🕵️ | Detective | `:male_detective:, :female_detective:` |
...
This cheat sheet is automatically generated from [GitHub Emoji API](https://api.github.com/emojis) and
